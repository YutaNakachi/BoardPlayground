...
オリジナルと、商標を使わない伝統的な抽象ゲームをブラウザで公開・プレイするサイト。
...
- **リバーシ** (`/play/reversi`) — 2人
- **マンカラ** (`/play/mancala`) — 2人
- **五目並べ** (`/play/gomoku`) — 2人、13×13
- **チェッカー** (`/play/checkers`) — 2人
- **ナイン・メンズ・モリス** (`/play/nine-mens-morris`) — 2人
