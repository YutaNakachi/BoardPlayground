...
ブラウザで今すぐ遊べるボードゲームサイト。オリジナルと、商標を使わない伝統的なボードゲームを公開・プレイします。
...
- **ネビュラ・リンク** (`/play/nebula-link`) — オリジナル、2〜4人、約12分
...
- 系統: オリジナル / クラシック / トリビュート / フィクション（詳細は `AGENTS.md`）
- 公開文に商標・商品名を出さない。新規ゲームは基本 `listed: false` で作り、掲載はオーナー判断
