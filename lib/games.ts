...
const games: GameMeta[] = [
  ...
  },
  {
    ...
    tags: ["ボード", "心理戦"],
    rulesSummary: [
      "21×21、中央1マスは星核。手番ではルーレットを回して3種から1つ置くか、単マスを使う（単マスはいつでも可）。",
      "初手は自分のホーム辺から。2手目以降は自分のブロックに角だけでつなぐ（辺では接しない）。相手への接触は制限なし。",
      "自分のマスは8方向でひとつながり。ホーム辺につながったグループで星核を閉じ込めたら即勝ち。",
      "今使える形をどれも置けなければパス。全員が連続パスしたら引き分け。3人では南辺は中立。",
    ],
    status: "playable",
    listed: true,
  },
  {
    ...
    tags: ["ボード", "心理戦"],
    rulesSummary: [
      "5×5の盤。手番は自分の駒1つで、移動・射撃、または旋回権があるときの旋回のいずれか1つ。",
      "指揮車は8方向1マス（体当たり可）。軽戦車は前と斜め前1マス・射程2。重戦車は前1マス・射程3。特攻車は斜め前最大2マスで体当たり可。",
      "軽戦車・重戦車・特攻車は、移動または射撃で手番を終えると旋回権が付く。旋回後は同じ駒で移動または射撃1回（続きでは旋回権なし）。外周で動けないときは180°の救済旋回だけで手番終了。",
