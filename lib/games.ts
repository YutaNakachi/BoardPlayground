...
const games: GameMeta[] = [
  ...
  },
  {
    ...
    title: "ネビュラ・リンク",
    description:
      "11×11の星雲盤でルーレットの形状ブロックを置き、星核を自分のホーム辺側に閉じ込めたら勝ち。",
    origin: "original",
    players: "2〜4",
    playersMin: 2,
    playersMax: 4,
    ...
    tags: ["ボード", "心理戦"],
    rulesSummary: [
      "11×11、中央1マスは星核。手番開始時ルーレットで3形状から1つ選び、単マスは常に使える。",
  ...
  },
  {
    ...
    title: "砲塔戦棋",
    description:
      "砲塔の向きと役割が異なる戦車で相手の指揮車を落とす2人対戦。軽・重は射撃、特攻車は体当たり、指揮車は全方位移動です。",
    origin: "original",
    players: "2",
    playersMin: 2,
    playersMax: 2,
    ...
    tags: ["ボード", "心理戦"],
    rulesSummary: [
      "5×5の盤。手番は1駒につき移動・旋回・射撃のいずれか1つ。",
      "指揮車は8方向1マス・射撃なし。軽は斜め前も可・射程2。重は前進1と射程3。特攻は斜め前2のみ体当たり。",
      "軽・重・特攻は移動または射撃のあと旋回権。外周で動けないときは180°救済旋回のみ。",
