...
const games: GameMeta[] = [
  ...
  },
  {
    ...
    title: "ネビュラ・リンク",
    description:
      "21×21の星雲盤でルーレットの形状ブロックを置き、星核を自分のホーム辺側に閉じ込めたら勝ち。",
    origin: "original",
    players: "2〜4",
    playersMin: 2,
    playersMax: 4,
    ...
    tags: ["ボード", "心理戦"],
    rulesSummary: [
      "21×21、中央1マスは星核。手番でルーレットを回し3形状から1つ選び、単マスは常に使える。",
      "初手はホーム辺から。2手目以降は自分のブロックに角だけで接続（辺接触禁止）。",
      "自分の連結グループがホーム辺につながり、星核をそのグループで閉じ込めたら即勝ち。",
      "置ける形がなければパス。全員連続パスで引き分け。",
    ],
    status: "playable",
    listed: true,
  },
