...
const games: GameMeta[] = [
  ...
  },
  {
    ...
    rulesSummary: [
      ...
      "すべての箱に所有者がついたら終了。多い方が勝ち。同数は共同勝利。",
    ],
    status: "playable",
    listed: true,
  },
  ...
  },
  {
    ...
    title: "ウサギと猟犬",
    description:
      "1匹のウサギと4匹の猟犬が8×8で対峙する追いかけっこ。ウサギは最上段へ到達し、猟犬は囲んで止める。",
    origin: "classic",
    players: "2",
    playersMin: 2,
    playersMax: 2,
    ...
    rulesSummary: [
      ...
      "ウサギが最上段に到達すればウサギの勝ち。動けなくなれば猟犬の勝ち。",
      "猟犬の手番で合法手がなければウサギの勝ち。駒の取り合いはない。",
    ],
    status: "playable",
    listed: true,
  },
  ...
  },
  {
    ...
    rulesSummary: [
      ...
      "セーフマス以外で相手と同じマスに止まると、そのマスの相手コマをスタートへ戻す。",
  ...
  },
  {
    ...
    rulesSummary: [
      ...
      "タブローは交互色で降順、空列にはキングのみ。組札はスートごとにAから昇順。",
      "4つの組札をすべて完成させれば勝ち。",
    ],
    status: "playable",
    listed: true,
  ...
  },
  {
    ...
    rulesSummary: [
      ...
      "同じ種類の牌を2枚選んで取り除く。",
      "合法なペアがなくなったら行き詰まり（負け）。シャッフル機能はない。",
      "盤上の牌をすべて取り除けば勝ち。",
    ],
    status: "playable",
    listed: true,
